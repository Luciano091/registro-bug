...
export const FloatingCart = ({ onOpen }: FloatingCartProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 z-40 md:left-auto md:right-8 md:bottom-8 md:w-80">
      <button 
        onClick={onOpen}
        className="w-full bg-brand-500 hover:bg-brand-600 text-white p-4 rounded-2xl shadow-xl shadow-brand-500/25 flex items-center justify-between transition-all active:scale-[0.98]"
      >
