...
export const FloatingCart = ({ onOpen }: FloatingCartProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 z-40 md:left-auto md:right-8 md:bottom-8 md:w-80">
      <button 
        onClick={onOpen}
        className="flex w-full items-center justify-between rounded-2xl bg-brand-500 p-4 text-white shadow-xl shadow-brand-500/25 transition-all hover:bg-brand-600 active:scale-[0.98]"
      >
