...
export const PromoPopup = () => {
  ...
  useEffect(() => {
    // Só mostra o popup uma vez por sessão
  ...
  return (
    <>
      <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] animate-in fade-in duration-300" onClick={() => setShow(false)} />
