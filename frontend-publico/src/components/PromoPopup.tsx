  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-sm z-[101] animate-in zoom-in-95 fade-in duration-300">
        <div role="dialog" aria-modal="true" aria-labelledby="promo-popup-title" className="bg-white rounded-3xl shadow-2xl p-6 relative overflow-hidden">
          ...
          <button 
            onClick={dismiss}
            aria-label="Fechar oferta de cupom"
          ...
          <div className="flex flex-col items-center text-center mt-2">
            <div className="w-20 h-20 bg-orange-100 text-brand-600 rounded-full flex items-center justify-center rotate-[-10deg] shadow-inner mb-4 relative">
            ...
            <h2 id="promo-popup-title" className="text-2xl font-black text-slate-900 font-heading mb-2">Ganhe cupons!</h2>
            ...
            <button 
              ...
              className="w-full bg-brand-500 hover:bg-brand-600 active:bg-brand-700 text-white font-bold text-lg py-3.5 rounded-2xl transition-colors shadow-lg shadow-brand-500/20"
            >
              Pegar cupom
            </button>
          </div>
