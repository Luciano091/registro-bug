        ...
        <section className="flex min-h-[calc(100dvh-13.75rem)] flex-col pt-8">
          ...
          {isNativeApp ? (
            hasNativeGoogleAuth ? (
              ...
              <p className="mt-5 rounded-xl bg-amber-50 px-3 py-2 text-xs text-amber-900">Atualize o aplicativo para entrar com Google. <a className="font-bold underline" href="/app-bisburger.apk?v=2.0.4" target="_blank" rel="noreferrer">Baixar atualização</a></p>
            )
          ) : (
