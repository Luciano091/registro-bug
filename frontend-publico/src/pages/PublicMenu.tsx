      ...
      <footer className="mt-4 pb-4">
        <div className="mx-auto flex max-w-6xl flex-col items-center px-6 text-center opacity-70">
          ...
          {getEstablishmentSlug() === 'bisburger' && !isNativeApp && (
            <div className="mt-3">
              <a href="/app-bisburger.apk?v=2.0.7" download="BisBurger.apk" className="inline-flex items-center gap-1.5 rounded-full bg-slate-200/80 px-3 py-1.5 text-[10px] font-bold text-slate-700 hover:bg-slate-300 transition-colors">
