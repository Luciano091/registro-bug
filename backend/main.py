...
# `migrate_categories` foi uma correção pontual da base antiga. Executá-la
# em toda inicialização recriava categorias que o usuário havia excluído.
...
def auth_google(token_data: dict, db: Session = Depends(get_db)):
    ...
    CLIENT_ID = os.getenv("GOOGLE_CLIENT_ID") or "836965237182-kmgamm79oo3ft7kgifqom9ulj5u37mt2.apps.googleusercontent.com"
    try:
