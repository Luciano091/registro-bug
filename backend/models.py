...
class Cupom(Base):
    ...
    pedido_minimo = Column(Numeric(10, 2), nullable=False, default=0.0)
...
class OpcaoProduto(Base):
    ...
    nome = Column(String, nullable=False)
    preco_adicional = Column(Numeric(10, 2), nullable=False, default=0.0)
    ativo = Column(Boolean, nullable=False, default=True)
    ordem = Column(Integer, nullable=False, default=0)
...
class Pedido(Base):
    ...
    taxa_entrega = Column(Numeric(10, 2), default=0.0)
    taxa_servico = Column(Numeric(10, 2), default=0.0)
    cupom_codigo = Column(String, nullable=True)
    desconto = Column(Numeric(10, 2), default=0.0)
...
class Comanda(Base):
    ...
    desconto = Column(Numeric(10, 2), nullable=False, default=0.0)
    taxa_servico = Column(Numeric(10, 2), nullable=False, default=0.0)
...
class ItemPedido(Base):
    ...
    custo_unitario = Column(Numeric(10, 2), default=0.0)
    valor_unitario = Column(Numeric(10, 2), default=0.0)
    subtotal = Column(Numeric(10, 2), default=0.0)
...
class ItemPedidoOpcao(Base):
    ...
    preco_unitario = Column(Numeric(10, 2), nullable=False, default=0.0)
    quantidade = Column(Integer, nullable=False, default=1)
    subtotal = Column(Numeric(10, 2), nullable=False, default=0.0)
...
class Configuracao(Base):
    ...
    taxa_entrega = Column(Numeric(10, 2), default=5.0)
    entrega_habilitada = Column(Boolean, nullable=False, default=True)
    entrega_modo = Column(String, nullable=False, default="fixa")
    pedido_minimo_entrega = Column(Numeric(10, 2), nullable=False, default=0.0)
    entrega_gratis_acima = Column(Numeric(10, 2), nullable=True)
    raio_entrega_km = Column(Float, nullable=True)
    taxa_base_entrega = Column(Numeric(10, 2), nullable=False, default=0.0)
    distancia_base_km = Column(Float, nullable=False, default=0.0)
    taxa_por_km = Column(Numeric(10, 2), nullable=False, default=0.0)
    latitude = Column(Float, nullable=True)
    longitude = Column(Float, nullable=True)
...
class AreaEntrega(Base):
    ...
    taxa = Column(Numeric(10, 2), nullable=False, default=0.0)
    pedido_minimo = Column(Numeric(10, 2), nullable=False, default=0.0)
...
class Caixa(Base):
    ...
    saldo_inicial = Column(Numeric(10, 2), default=0.0)
